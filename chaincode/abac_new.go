...
func (s *SmartContract) CreateAsset(ctx contractapi.TransactionContextInterface, id string, color string, size int, appraisedValue int) error {
	...
	if err != nil {
		return fmt.Errorf("Could not get client identity. Error:", err.Error())
	}
	...
	if err != nil {
		return fmt.Errorf("Could not Marshal asset data. Error:", err.Error())
	}

	err = ctx.GetStub().PutState(id, assetJSON)
	if err != nil{
		return fmt.Errorf("Could not store data on ledger for asset with ID: %s. Error:",asset.ID, err.Error())
	}
	return nil
}
...
func (s *SmartContract) UpdateAsset(ctx contractapi.TransactionContextInterface, id string, newColor string, newSize int, newValue int) error {
	...
	if err != nil {
		return fmt.Errorf("Could not Read asset data from ledger. Error:", err.Error())
	}
...
func (s *SmartContract) DeleteAsset(ctx contractapi.TransactionContextInterface, id string) error {
	...
	if err != nil{
		return fmt.Errorf("Could not delete data on ledger for asset with ID: %s. Error:",id, err.Error())
	}
	return nil
}
...
func (s *SmartContract) TransferAsset(ctx contractapi.TransactionContextInterface, id string, newOwner string) error {
	...
	err =  ctx.GetStub().PutState(id, assetJSON)
	if err != nil{
		return fmt.Errorf("Could not store data on ledger for asset with ID: %s. Error:",id, err.Error())
	}
	return nil
}
